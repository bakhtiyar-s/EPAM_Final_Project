...
public class RemoveFromCartService implements Service {
    private static final Logger LOGGER = LogManager.getLogger(RemoveFromCartService.class.getName());
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        MenuItem menuItemToRemove = cart.keySet().stream().filter(menuItem -> menuItemId == menuItem.getId()).findAny().orElse(null);
        cart.remove(menuItemToRemove);
